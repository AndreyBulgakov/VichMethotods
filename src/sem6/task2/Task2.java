...
//        double[] b = {-1.0, 13.0, 9.0};
     ...
     * Здесь Лебедева А.В хочет что бы элементы ниже главной диагонали не вычислялись
     * Поэтому считаем с k+1 значения
     * см. Замечания в методичке Пакулиной
     * */
     ...
     * Аналогично предыдущему считаем с k+1
     * см. Замечания методички
     * */
